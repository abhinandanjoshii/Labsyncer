...
import labSyncer.services.FileSharer;
...
public class FileController {
    ...
    public void start() {
        server.start();
        System.out.println("Labsyncer started on port " + server.getAddress().getPort());
    }

    public void stop() {
        server.stop(0);
        executorService.shutdown();
        System.out.println("Labsyncer server stopped");
    }
    ...
    private static class MultipartParser {
        ...
        public ParseResult parse() {
            try {
                ...
                System.err.println("Error parsing multipart data: Contact : BT22CSE012 " + e.getMessage());
                return null;
            }
        }
    ...
    private class UploadHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                String response = "Server error - contact BT22CSE012 : " + e.getMessage();
